...
export default function Showcase() {
    ...
    return (
        <div>
            ...
            {/* https://my.matterport.com/show/?m=rvKhT7rSPML */}
        </div >
    );
    // return (
    //     <div>
    //         {!galleryInfo[0] ? <div><h1>Your Next House</h1> <br></br><div>{<iframe width="853" height="480" src={`https://my.matterport.com/show/?m=rvKhT7rSPML`} frameborder='0' allowfullscreen allow="xr-spatial-tracking"></iframe>}</div></div> : (
    //             <div>
    //                 <h1>Showcase</h1>
    //                 <h1>Display customer information </h1>
    //                 <QRCode value={`http://localhost:3000/${galleryInfo[0].customer_id}/showcase`} />
    //                 <div>{<iframe width="853" height="480" src={`${galleryInfo[0].img_url}`} frameborder='0' allowfullscreen allow="xr-spatial-tracking"></iframe>}</div>
    //                 {/* {<iframe width="853" height="480" src="https://my.matterport.com/show/?m=CoPaqg84uwx&brand=0" frameborder='0' allowfullscreen allow="xr-spatial-tracking"></iframe>} */}
    //                 <GoogleMaps address={galleryInfo[0].address} city={galleryInfo[0].city} state={galleryInfo[0].state} zipcode={galleryInfo[0].zipcode} />
    //             </div>
    //         )
